...
import '../../services/other/get_daily_leaderboard_service.dart';
import '../../utils/result/data_api_result.dart';

class GetDailyLeaderboardViewModel extends ChangeNotifier {
  ...
  Future<void> fetchDailyLeaderboard(String token) async {
    _isLoading = true;
    notifyListeners();

    try {
      _result = await GetDailyLeaderboardService.fetchDailyLeaderboard(token);

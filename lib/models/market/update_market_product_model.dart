class UpdateMarketProductModel {
  int id;
  int companyId;
  String productName;
  ...
  factory UpdateMarketProductModel.fromJson(Map<String, dynamic> json) {
    return UpdateMarketProductModel(
      id: json['id'] as int? ?? 0,

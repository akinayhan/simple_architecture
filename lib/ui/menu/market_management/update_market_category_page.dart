...
class UpdateMarketCategoryPage extends StatefulWidget {
  final int companyId;
  final String token;

  const UpdateMarketCategoryPage({super.key, required this.companyId, required this.token});

  @override
  UpdateMarketCategoryPageState createState() => UpdateMarketCategoryPageState();
}

class UpdateMarketCategoryPageState extends State<UpdateMarketCategoryPage> {
      ...
      onChanged: (value) {
        setState(() {
          ...
          _selectedMarketCategoryName = getMarketCategoriesViewModel.items
              ...
              .categoryName;
          _categoryNameController.text = _selectedMarketCategoryName ?? '';
        });
      },
